...
const PostActions = ({ post, targetCommentId = null }) => {
    ...
    // Estado para controlar si ya hemos hecho el scroll hacia el objetivo
    const [hasScrolledToTarget, setHasScrolledToTarget] = useState(false);

    // Inyectamos el cerebro actualizado
    const {
        ...
        <div style={{ padding: "0 15px 15px 15px", textAlign: "left" }}>
            ...
            {showComments && (
                <div style={{ borderTop: "1px solid #262626", paddingTop: "15px" }}>
                    ...
                    {/* INPUT AREA */}
                    {/* ... Todo tu código de input area (menciones y el input text) sigue exactamente igual aquí debajo ... */}
